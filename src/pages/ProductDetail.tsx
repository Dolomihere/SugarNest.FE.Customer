          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
              ...
              <a
                href="#"
                title=""
                className="text-white mt-4 sm:mt-0 bg-[#1d4ed8] hover:bg-[#1e40af] focus:ring-4 focus:ring-[#93c5fd] font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-[#2563eb] dark:hover:bg-[#1d4ed8] focus:outline-none dark:focus:ring-[#1e40af] flex items-center justify-center"
                role="button"
              >
                <svg
                  className="w-5 h-5 -ms-2 me-2"
